        ...
        try {
            $order = DB::transaction(function () use (
                ...
                $order = Order::query()->create([
                    ...
                    'customer_identification' => (string) $checkoutData['customer_identification'],
                    'billing_province' => (string) $checkoutData['billing_province'],
                    'billing_city' => (string) $checkoutData['billing_city'],
                    'billing_address' => (string) $checkoutData['billing_address'],
