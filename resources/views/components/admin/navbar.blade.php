<nav class="navbar admin-navbar navbar-dark sticky-top px-3" aria-label="Barra superior administrativa">
    ...
    <div class="d-flex align-items-center gap-2 text-white"><span class="small d-none d-sm-inline" aria-label="Notificaciones provisionales">Sin notificaciones</span><span class="badge rounded-pill text-bg-light" aria-label="Perfil provisional">Administrador</span></div>
</nav>
